    ...
    public void publishOutboxEvents() {
        ...
        for (OutboxEvent event : events) {
            try {
                ...
                String routingKey = RabbitMQConfig.PAYMENT_REQUEST_ROUTING_KEY; // Default for now
                
                rabbitTemplate.convertAndSend(RabbitMQConfig.ORDERS_EXCHANGE, routingKey, event.getEventData());
